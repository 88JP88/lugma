...
$sub_domain=$sub_domaincon->dom();
  ...
  const apiUrlq = `'.$sub_domain.'/lugmacore/apiTools/v1/getResponsibleGroups/${profileId11}`;
...
<script>
  ...
  const apiUrlxx = `'.$sub_domain.'/lugmacore/apiTools/v1/getGroupsHighCounter/${profilexx}`;
