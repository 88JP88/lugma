...
<table id="mystudents-table" class="table table-striped">
...
$sub_domain=$sub_domaincon->dom();
  ...
  const subdominio = `'.$sub_domain.'/lugmacore/apiResources/v1/allMyStudents/${my_profyle}`;
 ...
 async function getStudents() {
  ...
  .then(data => {
    const publicgroupsTableBody = document.querySelector("#mystudents-table tbody");
