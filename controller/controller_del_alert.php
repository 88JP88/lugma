...
// $ch = curl_init($url);
  ...
  //echo $ss;
              $url = ''.$sub_domain.'/lugmacore/apiTools/v1/putAlert/';
...
if($response1 == "true"){
  ...
  $_SESSION["mensaje"]="Alerta Eliminada Correctamente";
  $_SESSION["error"]=$response1;

}
if($response1 != "true"){
  $_SESSION["respuesta"]="false";
  $_SESSION["mensaje"]="No se pudo Eliminar la Alerta o hubo un error";
  $_SESSION["error"]=$response1;
