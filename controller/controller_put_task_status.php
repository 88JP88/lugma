...
// $ch = curl_init($url);
  ...
  //echo $ss;
              $url = 'http://localhost/lugmacore/apiTools/v1/putTaskStatus/';
...
if($response1 == "true"){
  ...
  $_SESSION["mensaje"]="Estado Tarea Editado Correctamente";
  $_SESSION["error"]=$response1;

}
if($response1 != "true"){
  $_SESSION["respuesta"]="false";
  $_SESSION["mensaje"]="No se pudo Editar el estado de la tarea o hubo un error";
  $_SESSION["error"]=$response1;
